(ns clojure-kubernetes-client.specs.v1beta1-supplemental-groups-strategy-options
...
(declare v1beta1-supplemental-groups-strategy-options-data v1beta1-supplemental-groups-strategy-options)
...
(def v1beta1-supplemental-groups-strategy-options
  (ds/spec
