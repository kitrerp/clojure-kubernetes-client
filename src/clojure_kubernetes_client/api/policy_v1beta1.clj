...
(defn-spec create-pod-security-policy-with-http-info any?
  ...
  ([body v1beta1-pod-security-policy, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-pod-security-policy v1beta1-pod-security-policy
  "
  create a PodSecurityPolicy"
  ...
  ([body v1beta1-pod-security-policy, optional-params any?]
   (let [res (:data (create-pod-security-policy-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-pod-security-policy res st/string-transformer)
        res))))
...
(defn-spec delete-pod-security-policy v1beta1-pod-security-policy
  "
  delete a PodSecurityPolicy"
...
(defn-spec list-pod-security-policy v1beta1-pod-security-policy-list
  "
  list or watch objects of kind PodSecurityPolicy"
  ...
  ([optional-params any?]
   (let [res (:data (list-pod-security-policy-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-pod-security-policy-list res st/string-transformer)
        res))))
...
(defn-spec patch-pod-security-policy v1beta1-pod-security-policy
  "
  partially update the specified PodSecurityPolicy"
...
(defn-spec read-pod-security-policy v1beta1-pod-security-policy
  "
  read the specified PodSecurityPolicy"
...
(defn-spec replace-pod-security-policy-with-http-info any?
  ...
  ([name string?, body v1beta1-pod-security-policy, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-pod-security-policy v1beta1-pod-security-policy
  "
  replace the specified PodSecurityPolicy"
