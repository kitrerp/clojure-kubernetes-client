(ns clojure-kubernetes-client.api.internal-apiserver-v1alpha1
...
(defn-spec create-storage-version-with-http-info any?
  "
  create a StorageVersion"
  ([body v1alpha1-storage-version, ] (create-storage-version-with-http-info body nil))
  ([body v1alpha1-storage-version, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions" :post
             {:path-params   {}
              :header-params {}
...
(defn-spec create-storage-version v1alpha1-storage-version
  "
  create a StorageVersion"
  ([body v1alpha1-storage-version, ] (create-storage-version body nil))
  ([body v1alpha1-storage-version, optional-params any?]
   (let [res (:data (create-storage-version-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version res st/string-transformer)
        res))))


(defn-spec delete-collection-storage-version-with-http-info any?
  "
  delete collection of StorageVersion"
  ([] (delete-collection-storage-version-with-http-info nil))
  ([{:keys [pretty continue dryRun fieldSelector gracePeriodSeconds labelSelector limit orphanDependents propagationPolicy resourceVersion resourceVersionMatch timeoutSeconds body]} (s/map-of keyword? any?)]
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions" :delete
             {:path-params   {}
              :header-params {}
...
(defn-spec delete-collection-storage-version v1-status
  "
  delete collection of StorageVersion"
  ([] (delete-collection-storage-version nil))
  ([optional-params any?]
   (let [res (:data (delete-collection-storage-version-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-status res st/string-transformer)
        res))))


(defn-spec delete-storage-version-with-http-info any?
  "
  delete a StorageVersion"
  ([name string?, ] (delete-storage-version-with-http-info name nil))
  ([name string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" :delete
...
(defn-spec delete-storage-version v1-status
  "
  delete a StorageVersion"
  ([name string?, ] (delete-storage-version name nil))
  ([name string?, optional-params any?]
   (let [res (:data (delete-storage-version-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-status res st/string-transformer)
        res))))
...
(defn-spec get-api-resources-with-http-info any?
  ...
  []
  (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec list-storage-version-with-http-info any?
  "
  list or watch objects of kind StorageVersion"
  ([] (list-storage-version-with-http-info nil))
  ([{:keys [pretty allowWatchBookmarks continue fieldSelector labelSelector limit resourceVersion resourceVersionMatch timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec list-storage-version v1alpha1-storage-version-list
  "
  list or watch objects of kind StorageVersion"
  ([] (list-storage-version nil))
  ([optional-params any?]
   (let [res (:data (list-storage-version-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version-list res st/string-transformer)
        res))))


(defn-spec patch-storage-version-with-http-info any?
  "
  partially update the specified StorageVersion"
  ([name string?, body any?, ] (patch-storage-version-with-http-info name body nil))
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec patch-storage-version v1alpha1-storage-version
  "
  partially update the specified StorageVersion"
  ([name string?, body any?, ] (patch-storage-version name body nil))
  ([name string?, body any?, optional-params any?]
   (let [res (:data (patch-storage-version-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version res st/string-transformer)
        res))))


(defn-spec patch-storage-version-status-with-http-info any?
  "
  partially update status of the specified StorageVersion"
  ([name string?, body any?, ] (patch-storage-version-status-with-http-info name body nil))
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-storage-version-status v1alpha1-storage-version
  "
  partially update status of the specified StorageVersion"
  ([name string?, body any?, ] (patch-storage-version-status name body nil))
  ([name string?, body any?, optional-params any?]
   (let [res (:data (patch-storage-version-status-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version res st/string-transformer)
        res))))


(defn-spec read-storage-version-with-http-info any?
  "
  read the specified StorageVersion"
  ([name string?, ] (read-storage-version-with-http-info name nil))
  ([name string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-storage-version v1alpha1-storage-version
  "
  read the specified StorageVersion"
  ([name string?, ] (read-storage-version name nil))
  ([name string?, optional-params any?]
   (let [res (:data (read-storage-version-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version res st/string-transformer)
        res))))


(defn-spec read-storage-version-status-with-http-info any?
  "
  read status of the specified StorageVersion"
  ([name string?, ] (read-storage-version-status-with-http-info name nil))
  ([name string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-storage-version-status v1alpha1-storage-version
  "
  read status of the specified StorageVersion"
  ([name string?, ] (read-storage-version-status name nil))
  ([name string?, optional-params any?]
   (let [res (:data (read-storage-version-status-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version res st/string-transformer)
        res))))


(defn-spec replace-storage-version-with-http-info any?
  "
  replace the specified StorageVersion"
  ([name string?, body v1alpha1-storage-version, ] (replace-storage-version-with-http-info name body nil))
  ([name string?, body v1alpha1-storage-version, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-storage-version v1alpha1-storage-version
  "
  replace the specified StorageVersion"
  ([name string?, body v1alpha1-storage-version, ] (replace-storage-version name body nil))
  ([name string?, body v1alpha1-storage-version, optional-params any?]
   (let [res (:data (replace-storage-version-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version res st/string-transformer)
        res))))


(defn-spec replace-storage-version-status-with-http-info any?
  "
  replace status of the specified StorageVersion"
  ([name string?, body v1alpha1-storage-version, ] (replace-storage-version-status-with-http-info name body nil))
  ([name string?, body v1alpha1-storage-version, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-storage-version-status v1alpha1-storage-version
  "
  replace status of the specified StorageVersion"
  ([name string?, body v1alpha1-storage-version, ] (replace-storage-version-status name body nil))
  ([name string?, body v1alpha1-storage-version, optional-params any?]
   (let [res (:data (replace-storage-version-status-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1alpha1-storage-version res st/string-transformer)
        res))))
