...
(defn-spec create-namespaced-event-with-http-info any?
  "
  create an Event"
  ([namespace string?, body core-v1-event, ] (create-namespaced-event-with-http-info namespace body nil))
  ([namespace string?, body core-v1-event, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params namespace body)
...
(defn-spec create-namespaced-event core-v1-event
  "
  create an Event"
  ([namespace string?, body core-v1-event, ] (create-namespaced-event namespace body nil))
  ([namespace string?, body core-v1-event, optional-params any?]
   (let [res (:data (create-namespaced-event-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode core-v1-event res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-service-account-token-with-http-info any?
  ...
  ([name string?, namespace string?, body authentication-v1-token-request, ] (create-namespaced-service-account-token-with-http-info name namespace body nil))
  ([name string?, namespace string?, body authentication-v1-token-request, {:keys [dryRun fieldManager pretty]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec create-namespaced-service-account-token authentication-v1-token-request
  "
  create token of a ServiceAccount"
  ([name string?, namespace string?, body authentication-v1-token-request, ] (create-namespaced-service-account-token name namespace body nil))
  ([name string?, namespace string?, body authentication-v1-token-request, optional-params any?]
   (let [res (:data (create-namespaced-service-account-token-with-http-info name namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode authentication-v1-token-request res st/string-transformer)
        res))))
...
(defn-spec delete-namespaced-persistent-volume-claim v1-persistent-volume-claim
  "
  delete a PersistentVolumeClaim"
...
(defn-spec delete-namespaced-pod v1-pod
  "
  delete a Pod"
...
(defn-spec delete-namespaced-pod-template v1-pod-template
  "
  delete a PodTemplate"
...
(defn-spec delete-namespaced-resource-quota v1-resource-quota
  "
  delete a ResourceQuota"
...
(defn-spec delete-namespaced-service-account v1-service-account
  "
  delete a ServiceAccount"
...
(defn-spec delete-persistent-volume v1-persistent-volume
  "
  delete a PersistentVolume"
...
(defn-spec list-event-for-all-namespaces core-v1-event-list
  "
  list or watch objects of kind Event"
  ...
  ([optional-params any?]
   (let [res (:data (list-event-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode core-v1-event-list res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-event core-v1-event-list
  "
  list or watch objects of kind Event"
...
(defn-spec patch-namespaced-event core-v1-event
  "
  partially update the specified Event"
...
(defn-spec read-namespaced-event core-v1-event
  "
  read the specified Event"
...
(defn-spec replace-namespaced-event-with-http-info any?
  ...
  ([name string?, namespace string?, body core-v1-event, ] (replace-namespaced-event-with-http-info name namespace body nil))
  ([name string?, namespace string?, body core-v1-event, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-event core-v1-event
  "
  replace the specified Event"
  ([name string?, namespace string?, body core-v1-event, ] (replace-namespaced-event name namespace body nil))
  ([name string?, namespace string?, body core-v1-event, optional-params any?]
