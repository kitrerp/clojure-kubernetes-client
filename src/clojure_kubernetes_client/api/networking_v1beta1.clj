...
(defn-spec create-ingress-class-with-http-info any?
  ...
  ([body v1beta1-ingress-class, ] (create-ingress-class-with-http-info body nil))
  ([body v1beta1-ingress-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/networking.k8s.io/v1beta1/ingressclasses" :post
             {:path-params   {}
              :header-params {}
...
(defn-spec create-ingress-class v1beta1-ingress-class
  "
  create an IngressClass"
  ([body v1beta1-ingress-class, ] (create-ingress-class body nil))
  ([body v1beta1-ingress-class, optional-params any?]
   (let [res (:data (create-ingress-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-ingress-class res st/string-transformer)
        res))))
...
(defn-spec delete-collection-ingress-class-with-http-info any?
  ...
  ([{:keys [pretty continue dryRun fieldSelector gracePeriodSeconds labelSelector limit orphanDependents propagationPolicy resourceVersion resourceVersionMatch timeoutSeconds body]} (s/map-of keyword? any?)]
   (call-api "/apis/networking.k8s.io/v1beta1/ingressclasses" :delete
             {:path-params   {}
              :header-params {}
...
(defn-spec delete-ingress-class-with-http-info any?
  ...
  ([name string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/networking.k8s.io/v1beta1/ingressclasses/{name}" :delete
...
(defn-spec list-ingress-class-with-http-info any?
  ...
  ([{:keys [pretty allowWatchBookmarks continue fieldSelector labelSelector limit resourceVersion resourceVersionMatch timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/networking.k8s.io/v1beta1/ingressclasses" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec list-ingress-class v1beta1-ingress-class-list
  "
  list or watch objects of kind IngressClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-ingress-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-ingress-class-list res st/string-transformer)
        res))))
...
(defn-spec patch-ingress-class-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/networking.k8s.io/v1beta1/ingressclasses/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec patch-ingress-class v1beta1-ingress-class
  "
  partially update the specified IngressClass"
...
(defn-spec read-ingress-class-with-http-info any?
  ...
  ([name string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/networking.k8s.io/v1beta1/ingressclasses/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-ingress-class v1beta1-ingress-class
  "
  read the specified IngressClass"
...
(defn-spec replace-ingress-class-with-http-info any?
  ...
  ([name string?, body v1beta1-ingress-class, ] (replace-ingress-class-with-http-info name body nil))
  ([name string?, body v1beta1-ingress-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/networking.k8s.io/v1beta1/ingressclasses/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-ingress-class v1beta1-ingress-class
  "
  replace the specified IngressClass"
  ([name string?, body v1beta1-ingress-class, ] (replace-ingress-class name body nil))
  ([name string?, body v1beta1-ingress-class, optional-params any?]
