(ns clojure-kubernetes-client.api.node-v1
...
(defn-spec create-runtime-class-with-http-info any?
  ...
  ([body v1-runtime-class, ] (create-runtime-class-with-http-info body nil))
  ([body v1-runtime-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-runtime-class v1-runtime-class
  "
  create a RuntimeClass"
  ([body v1-runtime-class, ] (create-runtime-class body nil))
  ([body v1-runtime-class, optional-params any?]
   (let [res (:data (create-runtime-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-runtime-class res st/string-transformer)
        res))))
...
(defn-spec list-runtime-class v1-runtime-class-list
  "
  list or watch objects of kind RuntimeClass"
  ...
  ([optional-params any?]
   (let [res (:data (list-runtime-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-runtime-class-list res st/string-transformer)
        res))))
...
(defn-spec patch-runtime-class v1-runtime-class
  "
  partially update the specified RuntimeClass"
...
(defn-spec read-runtime-class v1-runtime-class
  "
  read the specified RuntimeClass"
...
(defn-spec replace-runtime-class-with-http-info any?
  ...
  ([name string?, body v1-runtime-class, ] (replace-runtime-class-with-http-info name body nil))
  ([name string?, body v1-runtime-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-runtime-class v1-runtime-class
  "
  replace the specified RuntimeClass"
  ([name string?, body v1-runtime-class, ] (replace-runtime-class name body nil))
  ([name string?, body v1-runtime-class, optional-params any?]
