(ns clojure-kubernetes-client.api.well-known
...
(defn-spec get-service-account-issuer-open-id-configuration-with-http-info any?
  "
...
(defn-spec get-service-account-issuer-open-id-configuration string?
  "
  get service account issuer OpenID configuration, also known as the 'OIDC discovery doc'"
  []
  (let [res (:data (get-service-account-issuer-open-id-configuration-with-http-info))]
