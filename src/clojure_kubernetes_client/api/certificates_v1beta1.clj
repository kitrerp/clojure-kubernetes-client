...
(defn-spec patch-certificate-signing-request-approval-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-certificate-signing-request-approval v1beta1-certificate-signing-request
  "
  partially update approval of the specified CertificateSigningRequest"
...
(defn-spec read-certificate-signing-request-approval-with-http-info any?
  ...
  ([name string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-certificate-signing-request-approval v1beta1-certificate-signing-request
  "
  read approval of the specified CertificateSigningRequest"
