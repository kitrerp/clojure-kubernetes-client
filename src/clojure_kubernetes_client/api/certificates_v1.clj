(ns clojure-kubernetes-client.api.certificates-v1
...
(defn-spec create-certificate-signing-request-with-http-info any?
  ...
  ([body v1-certificate-signing-request, ] (create-certificate-signing-request-with-http-info body nil))
  ([body v1-certificate-signing-request, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-certificate-signing-request v1-certificate-signing-request
  "
  create a CertificateSigningRequest"
  ([body v1-certificate-signing-request, ] (create-certificate-signing-request body nil))
  ([body v1-certificate-signing-request, optional-params any?]
   (let [res (:data (create-certificate-signing-request-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-certificate-signing-request res st/string-transformer)
        res))))
...
(defn-spec list-certificate-signing-request v1-certificate-signing-request-list
  "
  list or watch objects of kind CertificateSigningRequest"
  ...
  ([optional-params any?]
   (let [res (:data (list-certificate-signing-request-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-certificate-signing-request-list res st/string-transformer)
        res))))
...
(defn-spec patch-certificate-signing-request v1-certificate-signing-request
  "
  partially update the specified CertificateSigningRequest"
...
(defn-spec patch-certificate-signing-request-approval-with-http-info any?
  "
  partially update approval of the specified CertificateSigningRequest"
  ([name string?, body any?, ] (patch-certificate-signing-request-approval-with-http-info name body nil))
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec patch-certificate-signing-request-approval v1-certificate-signing-request
  "
  partially update approval of the specified CertificateSigningRequest"
  ([name string?, body any?, ] (patch-certificate-signing-request-approval name body nil))
  ([name string?, body any?, optional-params any?]
   (let [res (:data (patch-certificate-signing-request-approval-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-certificate-signing-request res st/string-transformer)
        res))))
...
(defn-spec patch-certificate-signing-request-status v1-certificate-signing-request
  "
  partially update status of the specified CertificateSigningRequest"
...
(defn-spec read-certificate-signing-request v1-certificate-signing-request
  "
  read the specified CertificateSigningRequest"
...
(defn-spec read-certificate-signing-request-approval-with-http-info any?
  "
  read approval of the specified CertificateSigningRequest"
  ([name string?, ] (read-certificate-signing-request-approval-with-http-info name nil))
...
(defn-spec read-certificate-signing-request-approval v1-certificate-signing-request
  "
  read approval of the specified CertificateSigningRequest"
  ([name string?, ] (read-certificate-signing-request-approval name nil))
  ([name string?, optional-params any?]
   (let [res (:data (read-certificate-signing-request-approval-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-certificate-signing-request res st/string-transformer)
        res))))
...
(defn-spec read-certificate-signing-request-status v1-certificate-signing-request
  "
  read status of the specified CertificateSigningRequest"
...
(defn-spec replace-certificate-signing-request-with-http-info any?
  ...
  ([name string?, body v1-certificate-signing-request, ] (replace-certificate-signing-request-with-http-info name body nil))
  ([name string?, body v1-certificate-signing-request, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-certificate-signing-request v1-certificate-signing-request
  "
  replace the specified CertificateSigningRequest"
  ([name string?, body v1-certificate-signing-request, ] (replace-certificate-signing-request name body nil))
  ([name string?, body v1-certificate-signing-request, optional-params any?]
...
(defn-spec replace-certificate-signing-request-approval-with-http-info any?
  ...
  ([name string?, body v1-certificate-signing-request, ] (replace-certificate-signing-request-approval-with-http-info name body nil))
  ([name string?, body v1-certificate-signing-request, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-certificate-signing-request-approval v1-certificate-signing-request
  "
  replace approval of the specified CertificateSigningRequest"
  ([name string?, body v1-certificate-signing-request, ] (replace-certificate-signing-request-approval name body nil))
  ([name string?, body v1-certificate-signing-request, optional-params any?]
...
(defn-spec replace-certificate-signing-request-status-with-http-info any?
  ...
  ([name string?, body v1-certificate-signing-request, ] (replace-certificate-signing-request-status-with-http-info name body nil))
  ([name string?, body v1-certificate-signing-request, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-certificate-signing-request-status v1-certificate-signing-request
  "
  replace status of the specified CertificateSigningRequest"
  ([name string?, body v1-certificate-signing-request, ] (replace-certificate-signing-request-status name body nil))
  ([name string?, body v1-certificate-signing-request, optional-params any?]
