...
(defn-spec create-ingress-class-with-http-info any?
  "
  create an IngressClass"
  ([body v1-ingress-class, ] (create-ingress-class-with-http-info body nil))
  ([body v1-ingress-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-ingress-class v1-ingress-class
  "
  create an IngressClass"
  ([body v1-ingress-class, ] (create-ingress-class body nil))
  ([body v1-ingress-class, optional-params any?]
   (let [res (:data (create-ingress-class-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-ingress-class res st/string-transformer)
        res))))
...
(defn-spec create-namespaced-ingress-with-http-info any?
  "
  create an Ingress"
  ([namespace string?, body v1-ingress, ] (create-namespaced-ingress-with-http-info namespace body nil))
  ([namespace string?, body v1-ingress, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-ingress v1-ingress
  "
  create an Ingress"
  ([namespace string?, body v1-ingress, ] (create-namespaced-ingress namespace body nil))
  ([namespace string?, body v1-ingress, optional-params any?]
   (let [res (:data (create-namespaced-ingress-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-ingress res st/string-transformer)
        res))))
...
(defn-spec delete-collection-ingress-class-with-http-info any?
  "
  delete collection of IngressClass"
  ([] (delete-collection-ingress-class-with-http-info nil))
...
(defn-spec delete-collection-ingress-class v1-status
  "
  delete collection of IngressClass"
  ([] (delete-collection-ingress-class nil))
  ([optional-params any?]
   (let [res (:data (delete-collection-ingress-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
...
(defn-spec delete-ingress-class-with-http-info any?
  "
  delete an IngressClass"
  ([name string?, ] (delete-ingress-class-with-http-info name nil))
...
(defn-spec delete-ingress-class v1-status
  "
  delete an IngressClass"
  ([name string?, ] (delete-ingress-class name nil))
  ([name string?, optional-params any?]
   (let [res (:data (delete-ingress-class-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-status res st/string-transformer)
        res))))
...
(defn-spec list-ingress-class-with-http-info any?
  "
  list or watch objects of kind IngressClass"
  ([] (list-ingress-class-with-http-info nil))
...
(defn-spec list-ingress-class v1-ingress-class-list
  "
  list or watch objects of kind IngressClass"
  ([] (list-ingress-class nil))
  ([optional-params any?]
   (let [res (:data (list-ingress-class-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-ingress-class-list res st/string-transformer)
        res))))
...
(defn-spec list-ingress-for-all-namespaces v1-ingress-list
  "
  list or watch objects of kind Ingress"
  ...
  ([optional-params any?]
   (let [res (:data (list-ingress-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-ingress-list res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-ingress v1-ingress-list
  "
  list or watch objects of kind Ingress"
...
(defn-spec patch-ingress-class-with-http-info any?
  "
  partially update the specified IngressClass"
  ([name string?, body any?, ] (patch-ingress-class-with-http-info name body nil))
...
(defn-spec patch-ingress-class v1-ingress-class
  "
  partially update the specified IngressClass"
  ([name string?, body any?, ] (patch-ingress-class name body nil))
  ([name string?, body any?, optional-params any?]
   (let [res (:data (patch-ingress-class-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-ingress-class res st/string-transformer)
        res))))
...
(defn-spec patch-namespaced-ingress v1-ingress
  "
  partially update the specified Ingress"
...
(defn-spec patch-namespaced-ingress-status v1-ingress
  "
  partially update status of the specified Ingress"
...
(defn-spec read-ingress-class-with-http-info any?
  "
  read the specified IngressClass"
  ([name string?, ] (read-ingress-class-with-http-info name nil))
...
(defn-spec read-ingress-class v1-ingress-class
  "
  read the specified IngressClass"
  ([name string?, ] (read-ingress-class name nil))
  ([name string?, optional-params any?]
   (let [res (:data (read-ingress-class-with-http-info name optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-ingress-class res st/string-transformer)
        res))))
...
(defn-spec read-namespaced-ingress v1-ingress
  "
  read the specified Ingress"
...
(defn-spec read-namespaced-ingress-status v1-ingress
  "
  read status of the specified Ingress"
...
(defn-spec replace-ingress-class-with-http-info any?
  "
  replace the specified IngressClass"
  ([name string?, body v1-ingress-class, ] (replace-ingress-class-with-http-info name body nil))
  ([name string?, body v1-ingress-class, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
...
(defn-spec replace-ingress-class v1-ingress-class
  "
  replace the specified IngressClass"
  ([name string?, body v1-ingress-class, ] (replace-ingress-class name body nil))
  ([name string?, body v1-ingress-class, optional-params any?]
   (let [res (:data (replace-ingress-class-with-http-info name body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1-ingress-class res st/string-transformer)
        res))))
...
(defn-spec replace-namespaced-ingress-with-http-info any?
  ...
  ([name string?, namespace string?, body v1-ingress, ] (replace-namespaced-ingress-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1-ingress, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-ingress v1-ingress
  "
  replace the specified Ingress"
  ([name string?, namespace string?, body v1-ingress, ] (replace-namespaced-ingress name namespace body nil))
  ([name string?, namespace string?, body v1-ingress, optional-params any?]
...
(defn-spec replace-namespaced-ingress-status-with-http-info any?
  ...
  ([name string?, namespace string?, body v1-ingress, ] (replace-namespaced-ingress-status-with-http-info name namespace body nil))
  ([name string?, namespace string?, body v1-ingress, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-ingress-status v1-ingress
  "
  replace status of the specified Ingress"
  ([name string?, namespace string?, body v1-ingress, ] (replace-namespaced-ingress-status name namespace body nil))
  ([name string?, namespace string?, body v1-ingress, optional-params any?]
