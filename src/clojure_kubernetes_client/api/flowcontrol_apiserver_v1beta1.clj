(ns clojure-kubernetes-client.api.flowcontrol-apiserver-v1beta1
...
(defn-spec create-flow-schema-with-http-info any?
  "
  create a FlowSchema"
  ([body v1beta1-flow-schema, ] (create-flow-schema-with-http-info body nil))
  ([body v1beta1-flow-schema, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas" :post
             {:path-params   {}
              :header-params {}
...
(defn-spec create-flow-schema v1beta1-flow-schema
  "
  create a FlowSchema"
  ([body v1beta1-flow-schema, ] (create-flow-schema body nil))
  ([body v1beta1-flow-schema, optional-params any?]
   (let [res (:data (create-flow-schema-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-flow-schema res st/string-transformer)
        res))))
...
(defn-spec create-priority-level-configuration-with-http-info any?
  ...
  ([body v1beta1-priority-level-configuration, ] (create-priority-level-configuration-with-http-info body nil))
  ([body v1beta1-priority-level-configuration, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations" :post
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec create-priority-level-configuration v1beta1-priority-level-configuration
  "
  create a PriorityLevelConfiguration"
  ([body v1beta1-priority-level-configuration, ] (create-priority-level-configuration body nil))
  ([body v1beta1-priority-level-configuration, optional-params any?]
   (let [res (:data (create-priority-level-configuration-with-http-info body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-priority-level-configuration res st/string-transformer)
        res))))
...
(defn-spec delete-collection-flow-schema-with-http-info any?
  ...
  ([{:keys [pretty continue dryRun fieldSelector gracePeriodSeconds labelSelector limit orphanDependents propagationPolicy resourceVersion resourceVersionMatch timeoutSeconds body]} (s/map-of keyword? any?)]
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas" :delete
             {:path-params   {}
              :header-params {}
...
(defn-spec delete-collection-priority-level-configuration-with-http-info any?
  ...
  ([{:keys [pretty continue dryRun fieldSelector gracePeriodSeconds labelSelector limit orphanDependents propagationPolicy resourceVersion resourceVersionMatch timeoutSeconds body]} (s/map-of keyword? any?)]
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations" :delete
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "continue" continue "dryRun" dryRun "fieldSelector" fieldSelector "gracePeriodSeconds" gracePeriodSeconds "labelSelector" labelSelector "limit" limit "orphanDependents" orphanDependents "propagationPolicy" propagationPolicy "resourceVersion" resourceVersion "resourceVersionMatch" resourceVersionMatch "timeoutSeconds" timeoutSeconds }
              :form-params   {}
...
(defn-spec delete-flow-schema-with-http-info any?
  ...
  ([name string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}" :delete
...
(defn-spec delete-priority-level-configuration-with-http-info any?
  ...
  ([name string?, {:keys [pretty dryRun gracePeriodSeconds orphanDependents propagationPolicy body]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}" :delete
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "gracePeriodSeconds" gracePeriodSeconds "orphanDependents" orphanDependents "propagationPolicy" propagationPolicy }
              :form-params   {}
...
(defn-spec get-api-resources-with-http-info any?
  ...
  []
  (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/" :get
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec list-flow-schema-with-http-info any?
  ...
  ([{:keys [pretty allowWatchBookmarks continue fieldSelector labelSelector limit resourceVersion resourceVersionMatch timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec list-flow-schema v1beta1-flow-schema-list
  "
  list or watch objects of kind FlowSchema"
  ...
  ([optional-params any?]
   (let [res (:data (list-flow-schema-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-flow-schema-list res st/string-transformer)
        res))))
...
(defn-spec list-priority-level-configuration-with-http-info any?
  ...
  ([{:keys [pretty allowWatchBookmarks continue fieldSelector labelSelector limit resourceVersion resourceVersionMatch timeoutSeconds watch]} (s/map-of keyword? any?)]
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations" :get
             {:path-params   {}
              :header-params {}
              :query-params  {"pretty" pretty "allowWatchBookmarks" allowWatchBookmarks "continue" continue "fieldSelector" fieldSelector "labelSelector" labelSelector "limit" limit "resourceVersion" resourceVersion "resourceVersionMatch" resourceVersionMatch "timeoutSeconds" timeoutSeconds "watch" watch }
              :form-params   {}
...
(defn-spec list-priority-level-configuration v1beta1-priority-level-configuration-list
  "
  list or watch objects of kind PriorityLevelConfiguration"
  ...
  ([optional-params any?]
   (let [res (:data (list-priority-level-configuration-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode v1beta1-priority-level-configuration-list res st/string-transformer)
        res))))
...
(defn-spec patch-flow-schema-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   ...
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec patch-flow-schema v1beta1-flow-schema
  "
  partially update the specified FlowSchema"
...
(defn-spec patch-flow-schema-status-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}/status" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-flow-schema-status v1beta1-flow-schema
  "
  partially update status of the specified FlowSchema"
...
(defn-spec patch-priority-level-configuration-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-priority-level-configuration v1beta1-priority-level-configuration
  "
  partially update the specified PriorityLevelConfiguration"
...
(defn-spec patch-priority-level-configuration-status-with-http-info any?
  ...
  ([name string?, body any?, {:keys [pretty dryRun fieldManager force]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status" :patch
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager "force" force }
              :form-params   {}
...
(defn-spec patch-priority-level-configuration-status v1beta1-priority-level-configuration
  "
  partially update status of the specified PriorityLevelConfiguration"
...
(defn-spec read-flow-schema-with-http-info any?
  ...
  ([name string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-flow-schema v1beta1-flow-schema
  "
  read the specified FlowSchema"
...
(defn-spec read-flow-schema-status-with-http-info any?
  ...
  ([name string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}/status" :get
             {:path-params   {"name" name }
              :header-params {}
...
(defn-spec read-flow-schema-status v1beta1-flow-schema
  "
  read status of the specified FlowSchema"
...
(defn-spec read-priority-level-configuration-with-http-info any?
  ...
  ([name string?, {:keys [pretty exact export]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}" :get
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "exact" exact "export" export }
              :form-params   {}
...
(defn-spec read-priority-level-configuration v1beta1-priority-level-configuration
  "
  read the specified PriorityLevelConfiguration"
...
(defn-spec read-priority-level-configuration-status-with-http-info any?
  ...
  ([name string?, {:keys [pretty]} (s/map-of keyword? any?)]
   (check-required-params name)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status" :get
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty }
              :form-params   {}
...
(defn-spec read-priority-level-configuration-status v1beta1-priority-level-configuration
  "
  read status of the specified PriorityLevelConfiguration"
...
(defn-spec replace-flow-schema-with-http-info any?
  ...
  ([name string?, body v1beta1-flow-schema, ] (replace-flow-schema-with-http-info name body nil))
  ([name string?, body v1beta1-flow-schema, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-flow-schema v1beta1-flow-schema
  "
  replace the specified FlowSchema"
  ([name string?, body v1beta1-flow-schema, ] (replace-flow-schema name body nil))
  ([name string?, body v1beta1-flow-schema, optional-params any?]
...
(defn-spec replace-flow-schema-status-with-http-info any?
  ...
  ([name string?, body v1beta1-flow-schema, ] (replace-flow-schema-status-with-http-info name body nil))
  ([name string?, body v1beta1-flow-schema, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}/status" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-flow-schema-status v1beta1-flow-schema
  "
  replace status of the specified FlowSchema"
  ([name string?, body v1beta1-flow-schema, ] (replace-flow-schema-status name body nil))
  ([name string?, body v1beta1-flow-schema, optional-params any?]
...
(defn-spec replace-priority-level-configuration-with-http-info any?
  ...
  ([name string?, body v1beta1-priority-level-configuration, ] (replace-priority-level-configuration-with-http-info name body nil))
  ([name string?, body v1beta1-priority-level-configuration, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-priority-level-configuration v1beta1-priority-level-configuration
  "
  replace the specified PriorityLevelConfiguration"
  ([name string?, body v1beta1-priority-level-configuration, ] (replace-priority-level-configuration name body nil))
  ([name string?, body v1beta1-priority-level-configuration, optional-params any?]
...
(defn-spec replace-priority-level-configuration-status-with-http-info any?
  ...
  ([name string?, body v1beta1-priority-level-configuration, ] (replace-priority-level-configuration-status-with-http-info name body nil))
  ([name string?, body v1beta1-priority-level-configuration, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name body)
   (call-api "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status" :put
             {:path-params   {"name" name }
              :header-params {}
              :query-params  {"pretty" pretty "dryRun" dryRun "fieldManager" fieldManager }
              :form-params   {}
...
(defn-spec replace-priority-level-configuration-status v1beta1-priority-level-configuration
  "
  replace status of the specified PriorityLevelConfiguration"
  ([name string?, body v1beta1-priority-level-configuration, ] (replace-priority-level-configuration-status name body nil))
  ([name string?, body v1beta1-priority-level-configuration, optional-params any?]
