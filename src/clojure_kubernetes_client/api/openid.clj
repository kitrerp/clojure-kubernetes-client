(ns clojure-kubernetes-client.api.openid
...
(defn-spec get-service-account-issuer-open-id-keyset-with-http-info any?
  "
...
(defn-spec get-service-account-issuer-open-id-keyset string?
  "
  get service account issuer OpenID JSON Web Key Set (contains public token verification keys)"
  []
  (let [res (:data (get-service-account-issuer-open-id-keyset-with-http-info))]
