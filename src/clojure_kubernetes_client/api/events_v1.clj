(ns clojure-kubernetes-client.api.events-v1
...
(defn-spec create-namespaced-event-with-http-info any?
  "
  create an Event"
  ([namespace string?, body events-v1-event, ] (create-namespaced-event-with-http-info namespace body nil))
  ([namespace string?, body events-v1-event, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
...
(defn-spec create-namespaced-event events-v1-event
  "
  create an Event"
  ([namespace string?, body events-v1-event, ] (create-namespaced-event namespace body nil))
  ([namespace string?, body events-v1-event, optional-params any?]
   (let [res (:data (create-namespaced-event-with-http-info namespace body optional-params))]
     (if (:decode-models *api-context*)
        (st/decode events-v1-event res st/string-transformer)
        res))))
...
(defn-spec list-event-for-all-namespaces events-v1-event-list
  "
  list or watch objects of kind Event"
  ...
  ([optional-params any?]
   (let [res (:data (list-event-for-all-namespaces-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode events-v1-event-list res st/string-transformer)
        res))))
...
(defn-spec list-namespaced-event events-v1-event-list
  "
  list or watch objects of kind Event"
...
(defn-spec patch-namespaced-event events-v1-event
  "
  partially update the specified Event"
...
(defn-spec read-namespaced-event events-v1-event
  "
  read the specified Event"
...
(defn-spec replace-namespaced-event-with-http-info any?
  ...
  ([name string?, namespace string?, body events-v1-event, ] (replace-namespaced-event-with-http-info name namespace body nil))
  ([name string?, namespace string?, body events-v1-event, {:keys [pretty dryRun fieldManager]} (s/map-of keyword? any?)]
   (check-required-params name namespace body)
...
(defn-spec replace-namespaced-event events-v1-event
  "
  replace the specified Event"
  ([name string?, namespace string?, body events-v1-event, ] (replace-namespaced-event name namespace body nil))
  ([name string?, namespace string?, body events-v1-event, optional-params any?]
